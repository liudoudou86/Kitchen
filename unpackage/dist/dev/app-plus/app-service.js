...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), o3(r4);
    ...
    methods: {
      ...
      getColdData() {
        ...
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/menu/menu.vue:153", res);
          this.coldData = res.result.data;
          this.loading = false;
        }).catch((err) => {
          formatAppLog("log", "at pages/menu/menu.vue:157", err);
        });
      },
      getFruitData() {
        this.loading = true;
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/menu/menu.vue:169", res);
          this.fruitData = res.result.data;
          this.loading = false;
        }).catch((err) => {
          formatAppLog("log", "at pages/menu/menu.vue:173", err);
        });
      },
      getOtherData() {
        this.loading = true;
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/menu/menu.vue:185", res);
          this.otherData = res.result.data;
          this.loading = false;
        }).catch((err) => {
          formatAppLog("log", "at pages/menu/menu.vue:189", err);
        });
      },
      getMaterials(item) {
        formatAppLog("log", "at pages/menu/menu.vue:194", item.materials);
        uni.hideLoading();
        uni.showModal({
          content: "\u914D\u6599\u8868\uFF1A\n" + item.materials,
          showCancel: false
    ...
    methods: {
      getTableData() {
        ...
        rn.callFunction({
          ...
          this.loading = false;
          formatAppLog("log", "at pages/morning/morning.vue:61", res);
        }).catch((err) => {
          formatAppLog("log", "at pages/morning/morning.vue:63", err);
        });
      },
      getRowData(item) {
        formatAppLog("log", "at pages/morning/morning.vue:68", "\u51C6\u5907\u4F20\u7684\u6570\u636E", item);
        uni.navigateTo({
          url: "modify/morningmodify?item=" + encodeURIComponent(JSON.stringify(item)),
          success: function(res) {
            formatAppLog("log", "at pages/morning/morning.vue:72", "\u56DE\u8C03\u6210\u529F", res);
          },
          fail: function(err) {
            formatAppLog("log", "at pages/morning/morning.vue:75", "\u56DE\u8C03\u5931\u8D25", err);
          }
        });
      }
    }
              ...
              return vue.openBlock(), vue.createBlock(_component_uni_tr, { key: index }, {
                default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_uni_td, { align: "left" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("view", null, vue.toDisplayString(item.morningfood), 1)
                    ]),
                    _: 2
                  }, 1024),
                  vue.createVNode(_component_uni_td, { align: "left" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("view", null, vue.toDisplayString(item.morningsoup), 1)
                    ]),
                    _: 2
                  }, 1024),
                  vue.createVNode(_component_uni_td, { align: "left" }, {
                  ...
                  vue.createVNode(_component_uni_td, { align: "left" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("view", null, vue.toDisplayString(item.other), 1)
                    ]),
                    _: 2
                  }, 1024),
    ...
    methods: {
      getTableData() {
        ...
        rn.callFunction({
          ...
          this.tableData = res.result.data;
          this.loading = false;
          formatAppLog("log", "at pages/noon/noon.vue:77", res);
        }).catch((err) => {
          formatAppLog("log", "at pages/noon/noon.vue:79", err);
        });
      },
      getRowData(item) {
        formatAppLog("log", "at pages/noon/noon.vue:84", "\u51C6\u5907\u4F20\u7684\u6570\u636E", item);
        uni.navigateTo({
          url: "modify/noonmodify?item=" + encodeURIComponent(JSON.stringify(item)),
          success: function(res) {
            formatAppLog("log", "at pages/noon/noon.vue:88", "\u56DE\u8C03\u6210\u529F", res);
          },
          fail: function(err) {
            formatAppLog("log", "at pages/noon/noon.vue:91", "\u56DE\u8C03\u5931\u8D25", err);
          }
        });
      }
    }
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.tableData, (item, index) => {
              return vue.openBlock(), vue.createBlock(_component_uni_tr, { key: index }, {
                default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_uni_td, { align: "left" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("view", null, vue.toDisplayString(item.cold), 1)
                    ]),
                    _: 2
                  }, 1024),
                  vue.createVNode(_component_uni_td, null, {
  ...
  var __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-f7ca1098"], ["__file", "D:/Coding/Kitchen/uni_modules/uni-section/components/uni-section/uni-section.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        materialsData: []
    ...
    methods: {
      getMaterialsData() {
        ...
        rn.callFunction({
          ...
          this.loading = false;
          formatAppLog("log", "at pages/material/material.vue:29", res);
        }).catch((err) => {
          formatAppLog("log", "at pages/material/material.vue:31", err);
        });
      }
    }
  };
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "uni-padding-wrap uni-common-mt" }, [
  ...
  var PagesMaterialMaterial = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "D:/Coding/Kitchen/pages/material/material.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {};
    },
    methods: {
      addMorningMenu() {
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/setting/setting.vue:34", res);
          uni.hideLoading();
          uni.showModal({
            content: "\u751F\u6210\u6210\u529F",
            showCancel: false
      ...
      addNoonMenu() {
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/setting/setting.vue:54", res);
          uni.hideLoading();
          uni.showModal({
            content: "\u751F\u6210\u6210\u529F",
            showCancel: false
      ...
      vue.createElementVNode("view", { class: "uni-padding-wrap uni-common-mt" }, [
        vue.createElementVNode("view", { class: "uni-btn-v" }, [
          ...
          vue.createElementVNode("view", { class: "uni-btn-v" }, [
            vue.createElementVNode("button", {
              type: "default",
              onClick: _cache[0] || (_cache[0] = ($event) => $options.addMorningMenu())
            }, "\u65E9\u9910\u83DC\u8C31")
          ]),
          vue.createElementVNode("view", { class: "uni-btn-v" }, [
            vue.createElementVNode("button", {
              type: "default",
              onClick: _cache[1] || (_cache[1] = ($event) => $options.addNoonMenu())
            }, "\u6B63\u9910\u83DC\u8C31")
          ])
        ])
      ])
  ...
  const _sfc_main$2 = {
    ...
    methods: {
      formSubmit: function(e) {
        const formData = e.detail.value;
        formatAppLog("log", "at pages/setting/submit/submit.vue:57", "\u63D0\u4EA4\u8868\u5355\u6570\u636E\uFF1A" + JSON.stringify(e.detail.value));
        rn.callFunction({
          ...
          formatAppLog("log", "at pages/setting/submit/submit.vue:67", res);
          uni.hideLoading();
          uni.showModal({
            content: "\u4FDD\u5B58\u6210\u529F",
            showCancel: false
          ...
          formatAppLog("log", "at pages/setting/submit/submit.vue:74", err);
          uni.hideLoading();
          uni.showModal({
            content: "\u4FDD\u5B58\u5931\u8D25",
            showCancel: false
      ...
      formReset: function(e) {
        formatAppLog("log", "at pages/setting/submit/submit.vue:83", "\u6E05\u7A7A\u6570\u636E");
      }
    }
  };
        ...
        vue.createElementVNode("form", {
          ...
          vue.createElementVNode("view", { class: "uni-form-item uni-column" }, [
            ...
            vue.createElementVNode("radio-group", { name: "time" }, [
              ...
              vue.createElementVNode("label", null, [
                vue.createElementVNode("radio", { value: "\u6B63\u9910\u4E3B\u83DC" }),
                vue.createElementVNode("text", null, "\u6B63\u9910-\u83DC")
              ]),
              vue.createElementVNode("label", null, [
                vue.createElementVNode("radio", { value: "\u6B63\u9910\u6C64" }),
