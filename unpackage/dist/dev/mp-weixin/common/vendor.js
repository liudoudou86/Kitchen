...
const pages = [
  ...
  {
    path: "pages/setting/vegetable/vegetable",
    style: {
...
var B = { request: (e) => index.request(e), uploadFile: (e) => index.uploadFile(e), setStorageSync: (e, t2) => index.setStorageSync(e, t2), getStorageSync: (e) => index.getStorageSync(e), removeStorageSync: (e) => index.removeStorageSync(e), clearStorageSync: () => index.clearStorageSync() }, H = { "uniCloud.init.paramRequired": "{param} required", "uniCloud.uploadFile.fileError": "filePath should be instance of File" };
